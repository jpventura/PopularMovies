...
import com.jpventura.popularmovies.domain.provider.base.BaseContentProvider;
...
public class PopularMoviesProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "com.jpventura.popularmovies";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return PopularMoviesDB.getInstance(getContext());
    }
