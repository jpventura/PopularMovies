 ...
 */
package com.jpventura.popularmovies.domain.accounts;
 ...
 */
public class DomainAccountAuthenticator extends AbstractAccountAuthenticator {

    public DomainAccountAuthenticator(Context context) {
        super(context);
    }
